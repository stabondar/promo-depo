...
export default class Trail
{
    constructor()
    {
        ...
        class ImageTrail {
            constructor() {
                // images container
                this.DOM = {content: document.querySelector('.hero__trail')};
                // array of Image objs, one per image element
                this.images = [];
                [...this.DOM.content.querySelectorAll('.hero__trail--img')].forEach(img => this.images.push(new Image(img)));
